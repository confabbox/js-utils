 ...
 * incompatible with Confabbox on the client and/or server sides.
 *
...
export function parseStandardURIString(str) {
    ...
    // whitespace. Anyway, the Confabbox app is not known to utilize unencoded
...
/**
 * Parses a specific URI which (supposedly) references a Confabbox resource
 * (location).
 *
 * @param {(string|undefined)} uri - The URI to parse which (supposedly)
 * references a Confabbox resource (location).
 * @public
 * @returns {{
 *     contextRoot: string,
 *     hash: string,
...
export function parseURIString(uri) {
    ...
    // Add the properties that are specific to a Confabbox resource (location)
    ...
    // XXX While the components/segments of pathname are URI encoded, Confabbox
