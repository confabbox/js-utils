...
// TODO: Move BrowserCapabilities from lib-confab here and use the JSON
// format for them.
...
export default class BrowserCapabilities {
     ...
     * @param {boolean} [isUsingIFrame] - True if confabbox is loaded in iframe
     * and false otherwise.
    ...
    /**
     * Checks whether the browser is supported by Confabbox.
     *
     * @returns {boolean}
     */
    isSupported() {
